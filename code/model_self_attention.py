...
torch.save(model.state_dict(), 'VT1\SelfAttention_model\model_SelfAttention3.pth')
...
loaded_model.load_state_dict(torch.load('VT1\SelfAttention_model\model_SelfAttention3.pth'))
loaded_model.eval()
'''
...
# 输出视频文件路径
output_path = 'VT1\\test_video\\test_val_SA.mp4'
