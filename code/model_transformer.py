...
# 1. 加载和预处理数据
data = pd.read_csv('VT1\data2\keypoints7.csv')
...
torch.save(model.state_dict(), 'VT1\\transformer_model\\model_transformer2.pth')
...
loaded_model.load_state_dict(torch.load('VT1\\transformer_model\\model_transformer2.pth'))
loaded_model.eval()
'''
...
# 输出视频文件路径
output_path = 'VT1\\test_video\\test_val_transformer.mp4'
